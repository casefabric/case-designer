...
export default abstract class ModelCanvas<
    ...
    DED extends DocumentableElementDefinition<GMD> = DocumentableElementDefinition<GMD>,
    EV extends ElementView<DED> = ElementView<DED>> {
    ...
    getElement(jointElementView: any): EV {
        return jointElementView.model.xyz_cde;
    }
     ...
     */
    refreshReferencingFields(definitionElement: DED) {
     ...
     */
    set selectedElement(element: EV | undefined) {
    ...
    get selectedElement(): EV | undefined {
     ...
     */
    getItemUnderMouse(e: any, self: EV | undefined = undefined): EV | undefined {
    ...
    __addElement<V extends EV>(element: V): V {
        if (this.loading) {
            return element;
        }
    ...
    getItem(id: string): EV | undefined {
