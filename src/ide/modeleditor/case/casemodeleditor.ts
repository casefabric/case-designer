...
export default class CaseModelEditor extends ModelEditor {
     ...
     */
    loadDefinition() {
        if (!this.caseFile.definition) return;
        ...
        this.canvas = new CaseCanvas(this, this.htmlContainer, this.caseFile.definition, this.undoManager);
    ...
    async saveModel() {
        ...
        if (this.canvas) {
            ...
            await this.canvas.undoManager.saveDefinition(this.canvas.caseDefinition);
        }
    }
