...
export default class TaskDefinition extends TaskStageDefinition {
     ...
     */
    createMapping(creator: Function, sourceRef?: string, targetRef?: string, taskParameter?: TaskParameterDefinition, implementationParameter?: ParameterDefinition<ModelDefinition>) {
